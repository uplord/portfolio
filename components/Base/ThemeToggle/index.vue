<template>
  <div class="toggle" @click="toggleTheme()">
    ...
    <svg class="moon" width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10.403 0C4.88958 0 0.425293 4.47768 0.425293 10C0.425293 15.5223 4.88958 20 10.403 20C13.1083 20 15.5592 18.9196 17.3583 17.1696C17.5815 16.9509 17.6396 16.6116 17.4967 16.3348C17.3539 16.058 17.0458 15.9018 16.7378 15.9554C16.3003 16.0312 15.8539 16.0714 15.394 16.0714C11.0681 16.0714 7.55922 12.5536 7.55922 8.21429C7.55922 5.27679 9.16636 2.71875 11.5458 1.37054C11.8182 1.21429 11.9565 0.901786 11.8896 0.598214C11.8226 0.294643 11.5637 0.0669644 11.2512 0.0401786C10.9699 0.0178572 10.6887 0.00446422 10.403 0.00446422V0Z" fill="#74C0FC"/>
    </svg>
  </div>
</template>
      ...
      toggleTheme: function() {
        ...
        if (theme == 'light') {
          ...
          if (document.getElementsByClassName('banner').length) {
            if (document.getElementsByClassName('banner')[0].classList.contains('is-auto')) {
